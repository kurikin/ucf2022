export const events = [
  {
    ...
    description:
      ...
      'VR 空間上で横国のキャンパスを再現する企画です。建物はBlender と Unity を使って忠実に作られています。皆さんは猫や人型のキャラクターになってキャンパスを自由に歩き回ることができます。ぜひ自分の学部の建物を訪れたりして、バーチャル横国を楽しんでください。プレイには PC が必要となります。（※Safari は非推奨）',
    comingsoon: false,
    firstButtonData: {
      text: '旧Ver をプレイ',
      type: 'link',
